      ...
      <div className={styles.main}>
        ...
        <div className={styles.left}>
          ...
          <div className={styles.cat}>
            <h2 className={styles.cathead}>Categories</h2>
            ...
            <div className={styles.rconts}>
              ...
              {products.map((p) => (
                ...
                >
                  ...
                  <p className={styles.rcsub}>{p.subName}</p>
                  <p className={styles.rcwatt}>{p.powerConsumption}</p>

                  <p className={styles.rcprice}>₹{p.price}</p>
